...
;; my mods for wxBUP - MSVC 2010 version
#define MyAppName "wxBUP"
#define MyAppFile "wxBup.exe"
#define MyAppVersion GetFileVersion( AddBackslash(SourcePath + "src") + MyAppName + ".exe" )

#pragma message MyAppVersion
;#define AppwxMs MyAppName + "-" + MyAppVersion
#pragma message AppwxBUP
#define AppOut  MyAppName + "-" + MyAppVersion + "-Unicode-Setup"
#pragma message AppOut

#pragma message "application : " + MyAppName
#pragma message "version info: " + MyAppVersion
#pragma message "Source:: " + AddBackslash(SourcePath + "src") + MyAppName + ".exe"
;; end of my mods for wxBUP
...
#define MyAppSetupName MyAppName
;#define MyAppVersion '7.70'
...
AppCopyright=Copyright © 2007-2018 AWW
VersionInfoVersion={#MyAppVersion}
;VersionInfoCompany=A. Wiegert
AppPublisher=A. Wiegert
...
; my stuff
LicenseFile="src\{#MyAppName}-License.txt"
...
[Files]
Source: "src\{#MyAppFile}"; DestDir: "{app}"; Check: not Is64BitInstallMode
Source: "src\{#MyAppName}Help.chm"; DestDir: {userappdata}\{#MyAppSetupName}; Flags: ignoreversion
Source: "src\{#MyAppName}-WhatsNew.txt"; DestDir: {userappdata}\{#MyAppSetupName}; Flags: ignoreversion isreadme
Source: "src\{#MyAppName}-Install.txt"; DestDir: {userappdata}\{#MyAppSetupName}; Flags: ignoreversion isreadme
Source: "src\Alarm10.wav"; DestDir: {userappdata}\{#MyAppSetupName}; Flags: ignoreversion
Source: "src\foghorn-daniel_simon-short.wav"; DestDir: {userappdata}\{#MyAppSetupName}; Flags: ignoreversion
Source: "src\railroad_crossing_bell-Brylon_Terry-7.wav"; DestDir: {userappdata}\{#MyAppSetupName}; Flags: ignoreversion
Source: "src\Ring10.wav"; DestDir: {userappdata}\{#MyAppSetupName}; Flags: ignoreversion 
...
[InstallDelete]
; keep the INI file
Type: files; Name: {app}\{#MyAppFile}
Type: files; Name: {userappdata}\{#MyAppName}Help.chm
Type: files; Name: {userappdata}\{#MyAppName}WhatsNew.txt
Type: files; Name: {userappdata}\{#MyAppName}Install.txt
Type: files; Name: {userappdata}\{#MyAppName}License.txt
